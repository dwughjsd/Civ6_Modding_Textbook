...
<AssetObjects..GeometryInstance>
	...
	<m_DataFiles>
		<Element>
			<m_ID text="GR2"/>
			<m_RelativePath text="LEAD_FELI_JasperKitty.fgx"/>
		</Element>
		<Element>
			<m_ID text="WIG"/>
			<m_RelativePath text="LEAD_FELI_JasperKitty.wig"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEAD_FELI_JasperKitty"/>
	<m_Description text="LEAD_FELI_JasperKitty"/>
	<m_Tags>
		<Element text="Leader"/>
	</m_Tags>
</AssetObjects..GeometryInstance>
